            ...
            >
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-violet-400 uppercase tracking-widest mb-1">CLICKI</p>
                        <p className="text-xs font-medium text-white">UGC</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            ...
            // Release to normal page scroll at the bounds so the section never
            // traps the user (scroll up out of it, or down past it).
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-[#0e0b20] overflow-hidden">
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    ...
                    >
                        Контент, который реально залетает
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
