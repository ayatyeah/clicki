...
const L = {
  ru: { call: 'Позвонить', tg: 'Написать в Telegram', wa: 'Написать в WhatsApp' },
  en: { call: 'Call', tg: 'Message on Telegram', wa: 'Message on WhatsApp' },
};
...
export default function FloatingContacts() {
  ...
  const t = L[lang] || L.ru;
  return (
    <div className="floating-contacts" aria-label="Quick contacts">
